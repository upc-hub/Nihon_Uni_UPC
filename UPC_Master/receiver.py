...
def receive_file(file_location, port):
    # device's IP address
    SERVER_HOST = "172.28.235.18"
    ...
    with open(base_directory+file_location+"/results/"+filename, "wb") as f:
        for _ in progress:
...
if __name__ == "__main__":
    ...
    receive_file(sys_name,job_folder)