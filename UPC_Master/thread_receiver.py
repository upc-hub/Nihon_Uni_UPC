...
def receive_file(file_location, port, SERVER):
    # device's IP address
...
if __name__ == "__main__":
    ...
    parser.add_argument("result", help="Result folder location")
    parser.add_argument("host", help="The host/IP address of the receiver")
    args = parser.parse_args()
    sys_name = args.file
    job_folder = args.result
    server_host = args.host
    receive_file(sys_name,job_folder, server_host)