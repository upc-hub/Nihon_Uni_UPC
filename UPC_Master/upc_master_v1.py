...
from master_operation_nssimulation import *
from master_connection import *
from master_connection_nssimulation import *
...
class UPC_Master:
	...
	def main(self):
		...
		if str(number) == '1':
			...
			print ("Ns-Simulation jobs will be processed in UPC system.")
			master_information = UPC_Master.master_info(file)
			worker_information = UPC_Master.worker_info(file)
